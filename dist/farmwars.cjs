...
// packages/farmwars/src/index.ts
var src_exports = {};
__export(src_exports, {
  ACTOR_STATS: () => ACTOR_STATS,
  DirectionDeltas: () => DirectionDeltas,
  FRAMES_PER_TICK: () => FRAMES_PER_TICK,
  FarmWarsEngine: () => FarmWarsEngine,
  GiftInterval: () => GiftInterval,
  GiftRewardPoints: () => GiftRewardPoints,
  ...
  TreeBearFruitAge: () => TreeBearFruitAge,
  ValidDirections: () => ValidDirections,
  applyBaseSetup: () => applyBaseSetup,
  applyEvent: () => applyEvent,
  applyFrame: () => applyFrame,
  applyTick: () => applyTick,
  createInitialState: () => createInitialState,
  giftPositionsForTurn: () => giftPositionsForTurn,
  goldenGamma: () => goldenGamma,
  handleDeposits: () => handleDeposits,
  mulberry32: () => mulberry32,
  parseActions: () => parseActions,
  resolveCombat: () => resolveCombat,
  serializeForSide: () => serializeForSide,
  team1Bases: () => team1Bases,
  team2Bases: () => team2Bases,
  wireState: () => wireState
});
...
//# sourceMappingURL=farmwars.cjs.map